...
--
-- Name: spectral_options; Type: TYPE; Schema: public; Owner: Lawty
--

CREATE TYPE public.spectral_options AS ENUM (
    'O',
    'B',
    'A',
    'F',
...
ALTER TYPE public.spectral_options OWNER TO "Lawty";
...
--
-- Name: moons_designation_seq; Type: SEQUENCE; Schema: public; Owner: Lawty
--
...
ALTER TABLE public.moons_designation_seq OWNER TO "Lawty";

--
-- Name: moons_designation_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Lawty
--
...
CREATE TABLE public.stars (
    ...
    spectral_type public.spectral_options NOT NULL,
...
--
-- Name: moons designation; Type: DEFAULT; Schema: public; Owner: Lawty
--
...
--
-- Name: moons_designation_seq; Type: SEQUENCE SET; Schema: public; Owner: Lawty
--
...
--
-- Name: planets fk_star; Type: FK CONSTRAINT; Schema: public; Owner: Lawty
--

ALTER TABLE ONLY public.planets
    ADD CONSTRAINT fk_star FOREIGN KEY (star_id) REFERENCES public.stars(id);
